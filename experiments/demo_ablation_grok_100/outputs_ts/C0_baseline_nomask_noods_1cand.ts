...
<TS version="2.1" language="zh-Hant">
    ...
    <context>
        ...
        <message>
            ...
            <translation>&lt;warning&gt; 此使用者沒有權限！</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>此演算法接受一個點圖層，並產生包含對應於這些輸入點的 Voronoi 多邊形的多邊形圖層。</translation>
        </message>
        <message>
...
By default the algorithm uses the strict OGC definition of polygon validity, where a polygon is marked as invalid if a self-intersecting ring causes an interior hole. If the "Ignore ring self intersections" option is checked, then this rule will be ignored and a more lenient validity check will be performed.
            ...
            <translation>此演算法會對向量圖層的幾何進行有效性檢查。
幾何會被分類為三組（有效、無效和錯誤），並為每個類別中的圖徵產生一個向量圖層。
預設情況下，此演算法使用嚴格的 OGC 多邊形有效性定義，若自相交的環造成內部洞，則將多邊形標記為無效。若勾選「忽略環的自相交」選項，則會忽略此規則並執行更寬鬆的有效性檢查。</translation>
        </message>
    </context>
    <context>
        <name>QObject</name>
        <message numerus="yes">
            ...
            <translation>
                <numerusform>函式 `attribute` 需要一或兩個參數。已給定 %n 個。</numerusform>
                <numerusform>函式 `attribute` 需要一或兩個參數。已給定 %n 個。</numerusform>
            </translation>
        </message>
        <message>
            ...
            <translation>匯入已於 %1 之 %2 取消</translation>
        </message>
        <message>
...
%2</translation>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>在搜尋圖徵的相同距離處找到多個相符圖徵，找到 %n 個圖徵</numerusform>
                <numerusform>在搜尋圖徵的相同距離處找到多個相符圖徵，找到 %n 個圖徵</numerusform>
            </translation>
        </message>
        <message>
...
Optionally, geodesic lines can be created, which represent the shortest path on the surface of an ellipsoid. When geodesic mode is used, it is possible to split the created lines at the antimeridian (±180 degrees longitude), which can improve rendering of the lines. Additionally, the distance between vertices can be specified. A smaller distance results in a denser, more accurate line.</source>
            <translation>此演算法會透過將輻射圖層上的點連接到樞紐圖層中相符的點，來建立樞紐與輻射圖。

哪個樞紐與每個點配對的判斷，是根據樞紐點上的樞紐 ID 欄位與輻射點上的輻射 ID 欄位進行比對。

如果輸入圖層不是點圖層，則會取幾何圖形表面上的點作為連接位置。

可選擇建立測地線，代表橢球體表面上的最短路徑。使用測地線模式時，可以在反子午線（±180 度經度）處分割建立的線，這可以改善線條的繪製。此外，可以指定頂點之間的距離。較小的距離會產生更密集、更精確的線。</translation>
        </message>
        <message>
...
結果圖層的屬性表格將包含所有輸入圖層的欄位。若發現名稱相同但類型不同的欄位，則匯出的欄位將自動轉換為字串類型欄位。同時也會新增儲存原始圖層名稱與來源的新欄位。

若任何輸入圖層包含 Z 或 M 值，則輸出圖層也會包含這些值。同樣地，若任何輸入圖層為多部分圖層，輸出圖層也會是多部分圖層。

可選擇設定合併圖層的目的座標參考系統 (CRS)。若未設定，CRS 將取自第一個輸入圖層。所有圖層都會重新投影以符合此 CRS。</translation>
        </message>
        <message>
...
If the selected layer has no selected features, the newly created layer will be empty.</source>
            <translation>此演算法會在給定的向量圖層中，建立包含所有選取圖徵的新圖層。

如果選取的圖層沒有選取的圖徵，則新建立的圖層將為空白。</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>double 座標 [&lt;b&gt;X,Y&lt;/b&gt;]</translation>
        </message>
        <message>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>%n 個圖徵已新增</numerusform>
                <numerusform>%n 個圖徵已新增</numerusform>
            </translation>
        </message>
        <message numerus="yes">
            ...
            <translation>
                <numerusform>%n 個圖徵已刪除</numerusform>
                <numerusform>%n 個圖徵已刪除</numerusform>
            </translation>
        </message>
        <message>
...
Both the encoding specified by an optional .cpg file and any encoding details present in the .dbf LDID header block are considered.</source>
            <translation>此演算法會擷取 Shapefile 中嵌入的屬性編碼資訊。

同時會考量選用 .cpg 檔案指定的編碼，以及 .dbf LDID 標頭區塊中的任何編碼詳細資訊。</translation>
        </message>
        <message>
...
%1</translation>
        ...
        <message>
            ...
            <translation>正在建立圖層：%1</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>來自「%2」的圖徵 (%1) 具有無效的幾何。請修正幾何，或變更此輸入的「無效圖徵篩選」選項，或在全域的處理設定中變更。</translation>
        </message>
    </context>
    <context>
        <name>QgisApp</name>
...
%3</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>OCSP 位置</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>沿著 linestring 幾何，起始直徑為 0.5 且結束直徑為 0.2 的可變寬度緩衝區。</translation>
        </message>
        <message>
            <source>Geometry parts are specified as an array of geometry parts.</source>
            <translation>幾何部件指定為幾何部件的陣列。</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>對應亮化因子的整數：&lt;ul&gt;&lt;li&gt;若因子大於 100，此函式會傳回較亮的顏色（例如，將因子設為 150 會傳回亮度增加 50% 的顏色）；&lt;/li&gt;&lt;li&gt;若因子小於 100，傳回的顏色會較暗，但建議使用 darker() 函式來達到此目的；&lt;/li&gt;&lt;li&gt;若因子為 0 或負數，傳回值未指定。&lt;/li&gt;&lt;/ul&gt;</translation>
        </message>
        <message>
            ...
            <translation>指定傳回值處理方式的字串。有效選項如下：&lt;br&gt;&lt;ul&gt;&lt;li&gt;all: 預設，所有最常見的值會以陣列形式傳回。&lt;/li&gt;&lt;li&gt;any: 傳回其中一個最常見的值。&lt;/li&gt;&lt;li&gt;median: 傳回最常見值的中央值。非算術值會被忽略。&lt;/li&gt;&lt;li&gt;real_majority: 傳回出現次數超過陣列大小一半的值。&lt;/li&gt;&lt;/ul&gt;</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>將字串轉換為整數。若無法轉換為整數則不傳回任何值（例如 '123asd' 為無效值）。</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>ANSI A (Letter; 8.5x11 英寸)</translation>
        </message>
    </context>
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>%1 轉換至少需要 %n 個 GCPs。請定義更多。</numerusform>
                <numerusform>%1 轉換至少需要 %n 個 GCPs。請定義更多。</numerusform>
            </translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>在 '%1' (GISBASE) 中找不到 GRASS，提供者與外掛程式將無法運作。</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>搜尋圖層中繼資料</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>縮放到選取(&amp;S)</translation>
        </message>
        <message>
    ...
    <context>
        ...
        <message>
            ...
            <translation>根據 %1，其準確度有限，&lt;b&gt;最多 %2 公尺&lt;/b&gt;。</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>智慧型參考線(&amp;S)</translation>
        </message>
        <message>
            <location filename="../src/ui/layout/qgslayoutdesignerbase.ui" />
            <source>Resize to &amp;Shortest</source>
            <translation>調整大小為最短(&amp;S)</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>資料表已成功截斷。</translation>
        </message>
    </context>
    <context>
...
The bigger the number, the faster zooming with the mouse wheel will be.</source>
            <translation>指定每次滑鼠滾輪移動時縮放層級的變化量。
數值越大，使用滑鼠滾輪縮放的速度就越快。</translation>
        </message>
    </context>
    <context>
...
錯誤：%2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>檔案 %1 已建立索引</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>&lt;b&gt;%s&lt;/b&gt; 的外掛程式相依性</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>QGIS 已偵測到一個過時的外掛程式遮罩了此 QGIS 版本附帶的較新版本。這可能是先前安裝 QGIS 的檔案所造成。您現在要移除舊外掛程式並取消遮罩較新版本嗎？</translation>
        </message>
        <message>
            <source>Error installing plugin dependency &lt;b&gt;%s&lt;/b&gt;: %s</source>
            <translation>安裝外掛程式相依性 &lt;b&gt;%s&lt;/b&gt; 時發生錯誤：%s</translation>
        </message>
    </context>
    <context>
...
SQL: %2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>一個由映射項目組成的陣列，每個映射項目包含 'name'、'type'、'aggregate' 和 'input' 值（以及選用的 'length' 和 'precision' 值）。</translation>
        </message>
    </context>
    <context>
...
p, li { white-space: pre-wrap; }
&lt;/style&gt;&lt;/head&gt;&lt;body style=" font-family:'Sans Serif'; font-size:9pt; font-weight:400; font-style:normal;"&gt;
&lt;p style=" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;"&gt;從向量檔案中擷取 &lt;span style=" font-weight:600;"&gt;所有&lt;/span&gt; 記錄（&lt;span style=" font-style:italic;"&gt;如果表格很大，此操作可能會耗費一些時間&lt;/span&gt;）&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>不支援地圖畫布旋轉。從 %1 重設為 0。</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;變更此選項不會修改原始資料來源或對光柵圖層執行任何重投影。相反地，若無法偵測或偵測錯誤，它可用於在此專案中覆寫圖層的 CRS。&lt;/span&gt;&lt;/p&gt;&lt;p&gt;應使用「處理」中的「&lt;span style=" font-style:italic;"&gt;Warp (reproject)&lt;/span&gt;」工具來重投影光柵來源，並永久變更資料來源的 CRS。&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>篩選傳回 %n 個圖徵</numerusform>
                <numerusform>篩選傳回 %n 個圖徵</numerusform>
            </translation>
        </message>
    </context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>值 &amp;lt; 0 表示比 1:1 更接近的比例，例如 -10 = 10:1&lt;br&gt;值為 0 會停用特定限制。</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>結果解析失敗。從 gml (%2) 猜測了 %n 個圖徵類型，但未解析任何圖徵。</numerusform>
                <numerusform>結果解析失敗。從 gml (%2) 猜測了 %n 個圖徵類型，但未解析任何圖徵。</numerusform>
            </translation>
        </message>
        <message>
    ...
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>, %n 快取命中</numerusform>
                <numerusform>, %n 快取命中</numerusform>
            </translation>
        </message>
    </context>
...
{0}</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>計算時空向量資料集中每個已註冊向量圖層的屬性單變量統計</translation>
        </message>
    </context>
</TS>