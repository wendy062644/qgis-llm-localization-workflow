...
<TS version="2.1" language="zh-Hant">
    ...
    <context>
        ...
        <message>
            ...
            <translation>此演算法會取用一個點圖層，並產生包含對應這些輸入點的 Voronoi 多邊形之多邊形圖層。
</translation>
        </message>
        <message>
...
By default the algorithm uses the strict OGC definition of polygon validity, where a polygon is marked as invalid if a self-intersecting ring causes an interior hole. If the "Ignore ring self intersections" option is checked, then this rule will be ignored and a more lenient validity check will be performed.
            ...
            <translation>此演算法會對向量圖層的幾何執行有效性檢查。
這些幾何會被分類為三個群組（有效、無效和錯誤），並為各類別中的圖徵產生向量圖層。
預設情況下，此演算法使用嚴格的 OGC 多邊形有效性定義，若自相交環導致內部洞，則多邊形會被標記為無效。若勾選「忽略環自相交」選項，則會忽略此規則並執行更寬鬆的有效性檢查。
</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>匯入已取消於%1/%2</translation>
        </message>
        <message>
...
%2</translation>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>在搜尋圖徵的相同距離處找到多個相符圖徵，找到%n個圖徵</numerusform>
                <numerusform>在搜尋圖徵的相同距離處找到多個相符圖徵，找到%n個圖徵</numerusform>
            </translation>
        </message>
        <message>
...
結果圖層的屬性表格將包含所有輸入圖層的欄位。若發現名稱相同但類型不同的欄位，則匯出的欄位會自動轉換為字串類型欄位。同時也會新增儲存原始圖層名稱與來源的欄位。

若任何輸入圖層包含 Z 或 M 值，則輸出圖層也會包含這些值。同樣地，若任何輸入圖層為多部分圖層，輸出圖層也會是多部分圖層。

您可以選擇設定合併圖層的目的坐標參考系統 (CRS)。若未設定，CRS 將取自第一個輸入圖層。所有圖層都會重新投影以符合此 CRS。</translation>
        </message>
        <message>
...
Both the encoding specified by an optional .cpg file and any encoding details present in the .dbf LDID header block are considered.</source>
            <translation>此演算法會提取嵌入在 Shapefile 中的屬性編碼資訊。

會同時考慮選用 .cpg 檔案指定的編碼，以及 .dbf LDID 標頭區塊中存在的任何編碼詳細資訊。</translation>
        </message>
        <message>
...
%1</translation>
        ...
        <message>
            ...
            <translation>圖層短名稱無效。它必須以不帶重音的英文字母開頭，後接任何英數字元、點、破折號或底線。</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>圖徵 (%1) 來自「%2」具有無效幾何。請修正幾何，或變更此輸入的「無效圖徵過濾」選項，或在處理設定中全域變更。</translation>
        </message>
    </context>
    <context>
        <name>QgisApp</name>
...
%3</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>指定傳回值處理方式的字串。有效選項為：&lt;br&gt;&lt;ul&gt;&lt;li&gt;all: 預設，所有最常見的值會以陣列傳回。&lt;/li&gt;&lt;li&gt;any: 傳回其中一個最常見的值。&lt;/li&gt;&lt;li&gt;median: 傳回最常見值的中位數。非算術值會被忽略。&lt;/li&gt;&lt;li&gt;real_majority: 傳回出現次數超過陣列大小一半的值。&lt;/li&gt;&lt;/ul&gt;</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>將字串轉換為整數。若值無法轉換為整數，則不返回任何值（例如 '123asd' 為無效）。</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>%1轉換至少需要%n個 GCP。請再定義更多。</numerusform>
                <numerusform>%1轉換至少需要%n個 GCP。請再定義更多。</numerusform>
            </translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>找不到 GRASS 於 '%1' (GISBASE)，提供者和外掛程式將無法運作。</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>縮放到選取項目(&amp;S)</translation>
        </message>
        <message>
    ...
    <context>
        ...
        <message>
            ...
            <translation>基於%1，其準確度有限，最高為&lt;b&gt;至多%2公尺&lt;/b&gt;.</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>調整為最短(&amp;S)</translation>
        </message>
    </context>
    <context>
...
The bigger the number, the faster zooming with the mouse wheel will be.</source>
            <translation>指定每次移動滑鼠滾輪時縮放層級的變化量。
...
錯誤：%2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>檔案%1已建立索引</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>外掛程式相依性適用於&lt;b&gt;%s&lt;/b&gt;</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>QGIS 已偵測到遮罩較新版本的過時外掛程式，此較新版本隨本 QGIS 提供。這可能是先前安裝 QGIS 的檔案所致。您要立即移除舊外掛程式並解除較新版本的遮罩嗎？</translation>
        </message>
        <message>
            <source>Error installing plugin dependency &lt;b&gt;%s&lt;/b&gt;: %s</source>
            <translation>安裝外掛程式相依性時發生錯誤&lt;b&gt;%s&lt;/b&gt;: %s</translation>
        </message>
    </context>
    <context>
...
SQL: %2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>一個映射項目的陣列，每個包含 'name'、'type'、'aggregate' 和 'input' 值（以及可選的 'length' 和 'precision' 值）。</translation>
        </message>
    </context>
    <context>
...
p, li{ white-space: pre-wrap; }
&lt;/style&gt;&lt;/head&gt;&lt;body style=" font-family:'Sans Serif'; font-size:9pt; font-weight:400; font-style:normal;"&gt;
&lt;p style=" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;"&gt;擷取&lt;span style=" font-weight:600;"&gt;所有&lt;/span&gt;向量檔案中的記錄 (&lt;span style=" font-style:italic;"&gt;若表格很大，此操作可能會耗費一些時間&lt;/span&gt;)&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;變更此選項不會修改原始資料來源或對光柵圖層執行任何重投影。相反地，若無法偵測或偵測不正確，它可用於在此專案中覆寫圖層的 CRS。&lt;/span&gt;&lt;/p&gt;&lt;p&gt;處理「&lt;span style=" font-style:italic;"&gt;扭曲（重投影）&lt;/span&gt;」工具應用於重投影光柵來源並永久變更資料來源的 CRS。&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>結果解析失敗。%n個圖徵類型從 gml (%2) 猜測出，但未解析任何圖徵。</numerusform>
                <numerusform>結果解析失敗。%n個圖徵類型從 gml (%2) 猜測出，但未解析任何圖徵。</numerusform>
            </translation>
        </message>
        <message>
...
{0}</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>計算時空向量資料集中每個已註冊向量圖層屬性的單變量統計</translation>
        </message>
    </context>
</TS>