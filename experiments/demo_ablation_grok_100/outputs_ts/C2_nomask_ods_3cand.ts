...
<TS version="2.1" language="zh-Hant">
    ...
    <context>
        ...
        <message>
            ...
            <translation>此演算法會取得一個點圖層，並產生包含對應於這些輸入點的沃羅諾伊多邊形的多邊形圖層。</translation>
        </message>
        <message>
...
By default the algorithm uses the strict OGC definition of polygon validity, where a polygon is marked as invalid if a self-intersecting ring causes an interior hole. If the "Ignore ring self intersections" option is checked, then this rule will be ignored and a more lenient validity check will be performed.
            ...
            <translation>此演算法對向量圖層的幾何進行效度檢查。
幾何會被分類為三組（有效、無效和錯誤），並為每個類別中的圖徵產生一個向量圖層。
預設情況下，演算法使用嚴格的 OGC 多邊形效度定義，若自相交環造成內部洞，則多邊形會被標記為無效。若勾選「忽略環的自相交」選項，則會忽略此規則並執行更寬鬆的效度檢查。</translation>
        </message>
    </context>
    <context>
        <name>QObject</name>
        ...
        <message>
            ...
            <translation>載入已於 %1 之 %2 取消</translation>
        </message>
        <message>
...
%2</translation>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>在搜尋圖徵的相同距離處找到多個匹配圖徵，找到 %n 個圖徵</numerusform>
                <numerusform>在搜尋圖徵的相同距離處找到多個匹配圖徵，找到 %n 個圖徵</numerusform>
            </translation>
        </message>
        <message>
...
Optionally, geodesic lines can be created, which represent the shortest path on the surface of an ellipsoid. When geodesic mode is used, it is possible to split the created lines at the antimeridian (±180 degrees longitude), which can improve rendering of the lines. Additionally, the distance between vertices can be specified. A smaller distance results in a denser, more accurate line.</source>
            <translation>此演算法透過將輻條圖層上點的線連接到集線器圖層中匹配的點，來建立集線器與輻條圖。

判斷哪個集線器與每個點對應的依據，是集線器點上的集線器 ID 欄位與輻條點上的輻條 ID 欄位之間的匹配。

若輸入圖層不是點圖層，則會將幾何圖形表面上的點作為連接位置。

可選擇建立測地線，代表橢球體表面上的最短路徑。使用測地模式時，可在反子午線（±180 度經度）處分割建立的線，這可改善線的繪製。此外，可指定頂點之間的距離。較小的距離會產生更密集、更精確的線。</translation>
        </message>
        <message>
...
結果圖層的屬性表將包含所有輸入圖層的欄位。若發現名稱相同但類型不同的欄位，則匯出的欄位將自動轉換為字串類型欄位。同時也會新增儲存原始圖層名稱和來源的欄位。

若任何輸入圖層包含 Z 或 M 值，則輸出圖層也會包含這些值。同樣地，若任何輸入圖層為多部分，輸出圖層也會是多部分圖層。

可選擇設定合併圖層的目的坐標參考系統 (CRS)。若未設定，CRS 將取自第一個輸入圖層。所有圖層都會重新投影以符合此 CRS。</translation>
        </message>
        <message>
...
If the selected layer has no selected features, the newly created layer will be empty.</source>
            <translation>此演算法會在給定的向量圖層中建立一個包含所有選取圖徵的新圖層。

若選取的圖層沒有選取的圖徵，則新建立的圖層將為空白。</translation>
        </message>
        <message>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>已新增 %n 個圖徵</numerusform>
                <numerusform>已新增 %n 個圖徵</numerusform>
            </translation>
        </message>
        <message numerus="yes">
...
Both the encoding specified by an optional .cpg file and any encoding details present in the .dbf LDID header block are considered.</source>
            <translation>此演算法會擷取內嵌於形狀檔中的屬性編碼資訊。

會同時考量選用的 .cpg 檔案所指定的編碼，以及 .dbf LDID 標頭區中存在的任何編碼詳細資訊。</translation>
        </message>
        <message>
...
%1</translation>
        ...
        <message>
            ...
            <translation>圖層簡短名稱無效。它必須以不帶重音的字母開頭，後接任何文數字、點、連字號或底線。</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>最大鄰居數量</translation>
        </message>
        <message>
            ...
            <translation>來自「%2」的圖徵 (%1) 具有無效的幾何。請修正幾何，或變更此輸入的「無效圖徵過濾」選項，或在處理設定中全域變更。</translation>
        </message>
    </context>
    <context>
        <name>QgisApp</name>
...
%3</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>沿線串幾何的變數寬度環域，起始直徑 0.5 結束直徑 0.2。</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>an integer corresponding to the lightening factor:&lt;ul&gt;&lt;li&gt;如果因子大於 100，此函式會傳回較亮的色彩（例如，將因子設為 150 會傳回亮度增加 50% 的色彩）；&lt;/li&gt;&lt;li&gt;如果因子小於 100，傳回的色彩會較暗，但建議使用 darker() 函式來達到此目的；&lt;/li&gt;&lt;li&gt;如果因子為 0 或負數，傳回值未指定。&lt;/li&gt;&lt;/ul&gt;</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>陣列少數值(陣列(0,1,42,42), 'all')</translation>
        </message>
        <message>
    ...
    <context>
        ...
        <message>
            ...
            <translation>ANSI A (信紙；8.5x11 英吋)</translation>
        </message>
    </context>
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>%1 轉換至少需要 %n 個 GCP。請再定義更多。</numerusform>
                <numerusform>%1 轉換至少需要 %n 個 GCP。請再定義更多。</numerusform>
            </translation>
        </message>
    </context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>縮放到選擇(&amp;S)</translation>
        </message>
        <message>
    ...
    <context>
        ...
        <message>
            ...
            <translation>基於 %1，其準確度有限，&lt;b&gt;最佳為 %2 公尺&lt;/b&gt;。</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>智慧型參考線(&amp;M)</translation>
        </message>
        <message>
            <location filename="../src/ui/layout/qgslayoutdesignerbase.ui" />
    ...
    <context>
        ...
        <message>
            ...
            <translation>變更框架厚度</translation>
        </message>
    </context>
    <context>
...
The bigger the number, the faster zooming with the mouse wheel will be.</source>
            <translation>指定每次移動滑鼠滾輪時縮放層次的變化量。
數字越大，使用滑鼠滾輪進行縮放的速度就越快。</translation>
        </message>
    </context>
    <context>
...
錯誤: %2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>檔案 %1 已經建立索引</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>&lt;b&gt;%s&lt;/b&gt; 的外掛程式依賴性</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>QGIS 偵測到一個過時的外掛程式，它遮罩了隨此 QGIS 複本提供的較新版本。這可能是因為先前安裝 QGIS 所留下的檔案所致。您是否要立即移除舊的外掛程式，並取消遮罩較新的版本？</translation>
        </message>
        <message>
            <source>Error installing plugin dependency &lt;b&gt;%s&lt;/b&gt;: %s</source>
            <translation>安裝外掛程式依賴性 &lt;b&gt;%s&lt;/b&gt; 時發生錯誤: %s</translation>
        </message>
    </context>
    <context>
...
SQL: %2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>一個由地圖項目組成的陣列，每個包含 'name'、'type'、'aggregate' 和 'input' 值（以及選用的 'length' 和 'precision' 值）。</translation>
        </message>
    </context>
    <context>
...
p, li { white-space: pre-wrap; }
&lt;/style&gt;&lt;/head&gt;&lt;body style=" font-family:'Sans Serif'; font-size:9pt; font-weight:400; font-style:normal;"&gt;
&lt;p style=" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;"&gt;擷取&lt;span style=" font-weight:600;"&gt;所有&lt;/span&gt;向量檔案中的記錄（&lt;span style=" font-style:italic;"&gt;如果表格很大，此操作可能會耗費一些時間&lt;/span&gt;）&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>地圖畫布旋轉不支援。正在從 %1 重設為 0。</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;變更此選項不會修改原始資料來源或對網格圖層執行任何再投影。相反地，如果無法偵測或偵測錯誤，它可用於在此專案中覆寫圖層的 CRS。&lt;/span&gt;&lt;/p&gt;&lt;p&gt;應使用處理「&lt;span style=" font-style:italic;"&gt;Warp (reproject)&lt;/span&gt;」工具來再投影網格來源，並永久變更資料來源的 CRS。&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>值 &amp;lt; 0 表示比例尺比 1:1 更接近，例如 -10 = 10:1&lt;br&gt;值為 0 會停用特定限制。</translation>
        </message>
    </context>
    <context>
