...
<TS version="2.1" language="zh-Hant">
    ...
    <context>
        ...
        <message>
            ...
            <translation>此演算法接受一個點圖層，並產生包含對應於這些輸入點的沃羅諾伊多邊形的多邊形圖層。
</translation>
        </message>
        <message>
...
By default the algorithm uses the strict OGC definition of polygon validity, where a polygon is marked as invalid if a self-intersecting ring causes an interior hole. If the "Ignore ring self intersections" option is checked, then this rule will be ignored and a more lenient validity check will be performed.
            ...
            <translation>此演算法會對向量圖層的幾何進行效度檢查。
這些幾何會被分類為三組（有效、無效和錯誤），並為各類別中的圖徵產生向量圖層。
預設會使用嚴格的 OGC 多邊形效度定義，若多邊形因自相交環導致內部洞，則標記為無效。若勾選「忽略環的自相交」選項，則忽略此規則並執行更寬鬆的效度檢查。
</translation>
        </message>
    </context>
    <context>
...
%2</translation>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>在搜尋圖徵的相同距離處找到多個匹配圖徵，找到%n個圖徵</numerusform>
                <numerusform>在搜尋圖徵的相同距離處找到多個匹配圖徵，找到%n個圖徵</numerusform>
            </translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>工作階段快取的驗證組態已清除</translation>
        </message>
        <message numerus="yes">
...
結果圖層的屬性表將包含所有輸入圖層的欄位。若發現名稱相同但類型不同的欄位，則匯出的欄位會自動轉換為字串類型欄位。同時也會新增儲存原始圖層名稱與來源的欄位。
...
If the selected layer has no selected features, the newly created layer will be empty.</source>
            <translation>此演算法會建立一個新圖層，包含給定向量圖層中的所有選取圖徵。
...
Both the encoding specified by an optional .cpg file and any encoding details present in the .dbf LDID header block are considered.</source>
            <translation>此演算法擷取嵌入在形狀檔中的屬性編碼資訊。

同時考量選用 .cpg 檔案指定的編碼，以及 .dbf LDID 標頭區中的任何編碼詳細資訊。</translation>
        </message>
        <message>
...
%1</translation>
        ...
        <message>
            ...
            <translation>圖層短名稱無效。它必須以不帶重音的字母開頭，後接任何文數字、點、破折號或底線。</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>圖徵 (%1) 來自「%2」的幾何無效。請修正幾何，或變更此輸入的「無效圖徵過濾」選項，或在處理設定中全域變更。</translation>
        </message>
    </context>
    <context>
        <name>QgisApp</name>
        <message>
            ...
            <translation>已成功儲存暫存圖層至&lt;a href="%1"&gt;%2&lt;/a&gt;</translation>
        </message>
        <message>
...
%3</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>幾何學部件指定為幾何學部件的陣列。</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>array_minority(陣列(0,1,42,42), 'all')</translation>
        </message>
        <message>
        ...
        <message>
            ...
            <translation>將字串轉換為整數。若值無法轉換為整數則不會傳回任何值（例如 '123asd' 為無效）。</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>%1轉換至少需要%n個 GCPs。請再定義更多。</numerusform>
                <numerusform>%1轉換至少需要%n個 GCPs。請再定義更多。</numerusform>
            </translation>
        </message>
    </context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>表已成功截斷。</translation>
        </message>
    </context>
    <context>
...
The bigger the number, the faster zooming with the mouse wheel will be.</source>
            <translation>指定滑鼠滾輪每次移動時縮放層級的變更量。
數值越大，使用滑鼠滾輪進行縮放的速度就越快。</translation>
        </message>
    </context>
    <context>
...
錯誤：%2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>外掛程式依賴性&lt;b&gt;%s&lt;/b&gt;</translation>
        </message>
    </context>
    <context>
...
SQL: %2</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>地圖項目的陣列，每個包含 'name'、'type'、'aggregate' 和 'input' 值（以及選用的 'length' 和 'precision' 值）。</translation>
        </message>
    </context>
    <context>
...
p, li{ white-space: pre-wrap; }
&lt;/style&gt;&lt;/head&gt;&lt;body style=" font-family:'Sans Serif'; font-size:9pt; font-weight:400; font-style:normal;"&gt;
&lt;p style=" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;"&gt;取得&lt;span style=" font-weight:600;"&gt;所有&lt;/span&gt;向量檔案中的記錄 (&lt;span style=" font-style:italic;"&gt;如果表格很大，此操作可能會耗費一些時間&lt;/span&gt;)&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;變更此選項不會修改原始資料來源或對網格圖層執行任何再投影。相反，若無法偵測或偵測錯誤，它可用於在此專案中覆寫圖層的 CRS。&lt;/span&gt;&lt;/p&gt;&lt;p&gt;處理「&lt;span style=" font-style:italic;"&gt;Warp (reproject)&lt;/span&gt;」工具應用來再投影網格來源並永久變更資料來源的 CRS。&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>插入%n列以下</numerusform>
                <numerusform>插入%n列以下</numerusform>
            </translation>
        </message>
    </context>
    ...
    <context>
        ...
        <message numerus="yes">
            ...
            <translation>
                <numerusform>結果解析失敗。%n個圖徵類型是從 gml (%2) 但沒有解析出任何圖徵。</numerusform>
                <numerusform>結果解析失敗。%n個圖徵類型是從 gml (%2) 但沒有解析出任何圖徵。</numerusform>
            </translation>
        </message>
        <message>
...
{0}</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>計算時空向量資料集中每個已註冊向量圖的屬性單變量統計</translation>
        </message>
    </context>
</TS>